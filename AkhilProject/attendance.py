...
class Attendance:
    def __init__(self, root):
        ...
        self.var_atten_attendance=StringVar()
         ...
         # first image
        # img=Image.open(r"face_recognition system/college_images/smart-attendance.jpg")
        ...
        f_lb1.place(x=0, y=0, width=800, height=200)
         ...
         #second image
        img1=Image.open(r"face_recognition system/college_images/iStock-182059956_18390_t12.jpg")
        ...
        img_left=Image.open(r"face_recognition system\college_images\AdobeStock_303989091.jpeg")
        ...
        attendanceID_entry=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_id,font=("Arial",11))
        attendanceID_entry.grid(row=0,column=1,padx=10,pady=8,sticky=W)

        #Roll
        rollLabel=Label(left_inside_frame,text="Roll:",font=("Arial",11,"bold"),bg="white")
        rollLabel.grid(row=0,column=2,padx=4,pady=8)

        atten_roll=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_roll,font=("Arial",11))
        ...
        atten_name=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_name,font=("comicsansns",11))
        ...
        atten_dep=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_dep,font=("comicsansns",11))
        ...
        atten_time=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_time,font=("comicsansns",11))
        ...
        atten_date=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_date,font=("comicsansns",11))
        ...
        self.atten_status=ttk.Combobox(left_inside_frame,width=22,textvariable=self.var_atten_attendance,font=("comicsansns",11),state="readonly")
       ...
       # ============== scroll bar table ===============================
        ...
        back_btn.place(x=1400, y=210, width=100, height=30)
