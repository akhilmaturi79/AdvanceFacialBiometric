...
class Student:
    def __init__(self, root):
        ...
        # first image
        img=Image.open(r"face_recognition system/college_images/face-recognition.png")
        ...
        f_lb1.place(x=0, y=0, width=500, height=130)
         ...
         #second image
        img1=Image.open(r"face_recognition system/college_images/smart-attendance.jpg")
        ...
        #third image
        img2=Image.open(r"face_recognition system/college_images/iStock-182059956_18390_t12.jpg")
        img2=img2.resize((500, 130), Image.LANCZOS)
        self.photoimg2=ImageTk.PhotoImage(img2)
        
        f_lb1 = Label(self.root, image=self.photoimg2)
        f_lb1.place(x=1000, y=0, width=540, height=130)
       ...
       #Department
        ...
        dep_combo["values"]=("Select Department","B-Tech","M-Tech","B-Phram","MBA","Diploma")
        dep_combo.current(0)
      ...
      #Course
        ...
        course_combo["values"]=("Select Course","Computer Science & Engineering (CSE)","Electical Engineering","Civil Engineering","Mechanical Engineering")
    ...
    #Class Student information
        class_Student_frame=LabelFrame(Left_frame,bd=2,relief=RIDGE,text="Class Student Information",font=("times new roman",13,"bold"))  
  ...
  #Right label frame
        ...
        img_right=Image.open(r"face_recognition system/college_images/gettyimages-1022573162.jpg")
...
#===================Search System ===================
 ...
 # =============table frame==================
    ...
    # Back button
        ...
        back_btn.place(x=1400, y=140, width=100, height=30)
...
#=====================function declaration============================
    ...
    def search_data(self):
        if self.search_combo.get() == "Select":
            # Reset the input fields and table if "Select" is chosen
            self.reset_data()
            self.student_table.delete(*self.student_table.get_children())
            messagebox.showinfo("Info", "Search fields have been reset", parent=self.root)
